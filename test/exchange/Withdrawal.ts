...
describe("Exchange.Withdrawal", () => {
  ...
  it("price impact, fees", async () => {
    ...
    // 0.1% => 0.001
    await dataStore.setUint(keys.withdrawalFeeFactorKey(ethUsdMarket.marketToken), decimalToFloat(1, 3));
    ...
    expect(await getClaimableFeeAmount(dataStore, ethUsdMarket.marketToken, wnt.address)).eq("11491948848848847"); // 0.0014989 + 0.009992998998998998
    expect(await getClaimableFeeAmount(dataStore, ethUsdMarket.marketToken, usdc.address)).eq("0");
    ...
    expect(await wnt.balanceOf(withdrawalHandler.address)).eq(0);
    expect(await usdc.balanceOf(withdrawalHandler.address)).eq(0);
    expect(await wnt.balanceOf(ethUsdMarket.marketToken)).eq("21990499499499499"); // 0.011997500500500501 + 0.09992998998998998 ETH, ~60 USD
    expect(await usdc.balanceOf(ethUsdMarket.marketToken)).eq(0);
    expect(await wnt.balanceOf(user0.address)).eq("9978009500500500501"); // 9.988002499499499499 - 0.009992998998998998 ETH
    expect(await usdc.balanceOf(user0.address)).eq(0);
    ...
    expect(await getClaimableFeeAmount(dataStore, ethUsdMarket.marketToken, wnt.address)).eq("11498272182097094"); // 0.001499774632447446
    expect(await getClaimableFeeAmount(dataStore, ethUsdMarket.marketToken, usdc.address)).eq("0");
    ...
    expect(await wnt.balanceOf(withdrawalHandler.address)).eq(0);
    expect(await usdc.balanceOf(withdrawalHandler.address)).eq(0);
    expect(await wnt.balanceOf(ethUsdMarket.marketToken)).eq("16500196674824822"); // 0.006501699125175174 ETH, ~32 USD
    expect(await usdc.balanceOf(ethUsdMarket.marketToken)).eq(0);
    expect(await wnt.balanceOf(user0.address)).eq("9983499803325175178"); // 9.993498300874824826 ETH
    expect(await usdc.balanceOf(user0.address)).eq(0);
