...
type SyntheticTokenConfig = {
  ...
  dataStreamBaseFeedId?: string;
  dataStreamFeedDecimals?: number;
  dataStreamSpreadReductionFactor?: BigNumber;
...
const sonicConfig: TokensConfig = {
  WS: {
    address: "0x039e2fB66102314Ce7b64Ce5Ce3E5183bc94aD38",
    decimals: 18,
    wrappedNative: true,
    transferGasLimit: 200 * 1000,
    oracleProvider: "storkOracle",
    dataStreamFeedId: "0x067948263411211a9dfe0cfbfbb1532eb3cf913423795534f5a22545ca16a18b",
  },
  scUSD: {
    ...
    transferGasLimit: 200 * 1000,
    oracleProvider: "storkOracle",
    dataStreamFeedId: "0xc5d44e1060cfb6c0f15f6cf65fed21d1bb790e87ac3de745e45f4c633eff5e6e",
  },
  WETH: {
    ...
    transferGasLimit: 200 * 1000,
    oracleProvider: "storkOracle",
    dataStreamFeedId: "0x8afba5f1a5d4969d23c3b42db1b88f8a9c8176392de5bf066752260478ce82b8",
  },
  WBTC: {
    decimals: 8,
    synthetic: true,
    oracleProvider: "storkOracle",
    dataStreamFeedId: "0x6b5b1c26f98c489ea35e449ccba14d6153182646efc9d09e56b4302e41be548d",
  },
  SOL: {
    decimals: 9,
    synthetic: true,
    oracleProvider: "storkOracle",
    dataStreamFeedId: "0x36a23533d9e287556851eea5493e66c0cd66529ca015166498e230588985351d",
  },
  ARB: {
    decimals: 18,
    synthetic: true,
    oracleProvider: "storkOracle",
    dataStreamFeedId: "0xad7687ab7bb2afe538fde015498c721ef7f9847f8e7f2da49b3c5e728e1d74b0",
  },
  HYPE: {
    decimals: 18,
    synthetic: true,
    oracleProvider: "storkOracle",
    dataStreamFeedId: "0x29a1ff67e425ea56ef0bdc3521926633cefc375a6ef35f366e12745660a4b014",
  },
  WIF: {
    decimals: 18,
    synthetic: true,
    oracleProvider: "storkOracle",
    dataStreamFeedId: "0x4e9195b2b18ab81cbfa66ca3c7ab603776c39c121da085d2069cf319fc6c6444",
  },
  TRUMP: {
    decimals: 18,
    synthetic: true,
    dataStreamFeedId: "0xf0989a7f28d4e3b2178b337567bf01f32d4771488a3f1cb740e469201092d41c",
    oracleProvider: "storkOracle",
  },
  PEPE: {
    decimals: 18,
    synthetic: true,
    dataStreamFeedId: "0xc8b7e1256c58483900ebb79d06d99ac8f192c3993317c4e5fd7abef38c9773c5",
    oracleProvider: "storkOracle",
  },
  XRP: {
    decimals: 6,
    synthetic: true,
    oracleProvider: "storkOracle",
    dataStreamFeedId: "0x0cec46730dec92ad5f42dd3aec38c3f173aa30e3786a5de1ee17c68c700a4c45",
  },
  SUI: {
    decimals: 9,
    synthetic: true,
    dataStreamFeedId: "0x5ac3e3750d518f96d2314f1708a43f934dd79027973b38a1a43261c2c5d6fb89",
    oracleProvider: "storkOracle",
  },
  DOGE: {
    decimals: 8,
    synthetic: true,
    dataStreamFeedId: "0x74d62b531207d0df96b54cb373d8148ee7f15a590b1ca519c012a736440f84cd",
    oracleProvider: "storkOracle",
  },
  FARTCOIN: {
    decimals: 18,
    synthetic: true,
    dataStreamFeedId: "0xbf7d6f49d9c18e8c4768302c0d50f7555c6353da3e3a7228bc8f80efef3f686e",
    oracleProvider: "storkOracle",
  },
  AAVE: {
    decimals: 18,
    synthetic: true,
    oracleProvider: "storkOracle",
    dataStreamFeedId: "0x9d7042b052e3fd80ec2a9d48cbcb0234961e4489851c687b35882b66565ce76e",
  },
  ENA: {
    decimals: 18,
    synthetic: true,
    oracleProvider: "storkOracle",
    dataStreamFeedId: "0xd61f24e1ac0fee19a3bc2a1b435b3729f0a6509e04548b69344449009e06bf7f",
  },
  "ETH/BTC": {
    decimals: 18,
    synthetic: true,
    oracleProvider: "storkOracle",
    dataStreamFeedId: "0x8afba5f1a5d4969d23c3b42db1b88f8a9c8176392de5bf066752260478ce82b8",
    dataStreamBaseFeedId: "0x6b5b1c26f98c489ea35e449ccba14d6153182646efc9d09e56b4302e41be548d",
  },
  // LDO: {
  // decimals: 18,
  // synthetic: true,
  // dataStreamFeedId: "0x663c2d2c32507b7c8a5d9ac519e036f69934fde678bc4cd5bfc2ac30ecebca69",
  // oracleProvider: "storkOracle",
  // },
};

const plasmaConfig: TokensConfig = {
  WXPL: {
    address: "0x6100E367285b01F48D07953803A2d8dCA5D19873",
    decimals: 18,
    wrappedNative: true,
    transferGasLimit: 200 * 1000,
    oracleProvider: "chainlinkOracle",
...
const config: {
  ...
  arbitrumSepolia: {
    XPL: {
      synthetic: true,
      decimals: 18,
      dataStreamFeedId: "0x000313f8bd40711b38e891c8646662ae33f892282536f355e1015634ace7aba7",
