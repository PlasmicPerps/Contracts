...
export default async function (hre: HardhatRuntimeEnvironment): Promise<RolesConfig> {
  ...
  const testnetAdmins = {
    // "0xF7F7Fe8DF31F5b8D181bf690e56DCfF22CB46a04": true, // dev wallet address
    // "0x5b5DA72C861cfa3D27ddc9CDFBD784833C168976": true, // oz relayer
    // "0x1ceb1C2d5e2a57132bebD8B2b3cF34A4eC69eb77": true, // oz relayer liquidations
    "0xe43D502ac03893e4c2dc95832b662fe9545db53F": true,
  };
  ...
  const config: {
    ...
    arbitrumSepolia: {
      CONTROLLER: {
        "0x42225fe31ef3D7301726b8E5752434239dde5D16": true, // admin
      },

      CONFIG_KEEPER: {
        "0x42225fe31ef3D7301726b8E5752434239dde5D16": true,
      },
      FEE_KEEPER: {
        "0x42225fe31ef3D7301726b8E5752434239dde5D16": true, // admin
      },
      ...
      MARKET_KEEPER: {
        "0x42225fe31ef3D7301726b8E5752434239dde5D16": true, // admin
        "0xe43D502ac03893e4c2dc95832b662fe9545db53F": true,
        "0xBca25c4Fa7d46C6Ad7FbF5b24E825a4D02eEB903": true,
      },
      ORDER_KEEPER: {
        "0x42225fe31ef3D7301726b8E5752434239dde5D16": true, // admin
        "0xe43D502ac03893e4c2dc95832b662fe9545db53F": true,
    ...
    sonic: {
      CONTROLLER: {
        "0xEd391C02480498543235157164107a70327484Bf": true, // admin
        "0x13919E105668792AB630148b03D6b91FF6df0491": true, // Common Pool wS
        "0x0bfFb867472cdaE11D0A10020Ab9a9d9Fdf6193b": true, // Common Pool scUSD
      },
      CONFIG_KEEPER: {
        "0xEd391C02480498543235157164107a70327484Bf": true, // admin
      },
      ...
      ORDER_KEEPER: {
        "0xEd391C02480498543235157164107a70327484Bf": true, // admin
        "0xF7F7Fe8DF31F5b8D181bf690e56DCfF22CB46a04": true, // internal admin
        "0x5b5DA72C861cfa3D27ddc9CDFBD784833C168976": true, // oz relayer mainnet
      },
      ADL_KEEPER: {
        "0xEd391C02480498543235157164107a70327484Bf": true, // admin
        "0xF7F7Fe8DF31F5b8D181bf690e56DCfF22CB46a04": true, // internal admin
    ...
    plasma: {
      CONTROLLER: {
        // "0x5dd5fec335c700390ac6eb331de8097c59346858": true, // admin
      },
      CONFIG_KEEPER: {
        "0x17f34aC85Df112f43262A748a813dA56a2eD78aa": true, // multisig_1
        "0x5dd5fec335c700390ac6eb331de8097c59346858": true, // admin
      },
      FEE_KEEPER: {
        "0x5dd5fec335c700390ac6eb331de8097c59346858": true,
        "0x17f34aC85Df112f43262A748a813dA56a2eD78aa": true, // admin
      },
      TIMELOCK_MULTISIG: {
        "0x17f34aC85Df112f43262A748a813dA56a2eD78aa": true, // multisig_1
      },
      ...
      ORDER_KEEPER: {
        "0x5dd5fec335c700390ac6eb331de8097c59346858": true, // admin
        "0x9adfbf2ea129b0ad38765aec68358f5c8d11f90b": true, // admin
      },
      ADL_KEEPER: {
        "0x5dd5fec335c700390ac6eb331de8097c59346858": true,
        "0x9adfbf2ea129b0ad38765aec68358f5c8d11f90b": true,
      },
      LIQUIDATION_KEEPER: {
        "0x5dd5fec335c700390ac6eb331de8097c59346858": true, // admin
        "0x9adfbf2ea129b0ad38765aec68358f5c8d11f90b": true, // admin
