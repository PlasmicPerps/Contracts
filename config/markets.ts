...
export type BaseMarketConfig = {
  ...
  withdrawalFeeFactor: BigNumberish;
...
const baseMarketConfig: Partial<BaseMarketConfig> = {
  ...
  borrowingFactorForLongs: decimalToFloat(3, 8), // 0.00000003 * 80% = 0.000000024, 0.0000024% / second, 94.61% per year if the pool is 100% utilized
  borrowingFactorForShorts: decimalToFloat(3, 8), // 0.00000003 * 80% = 0.000000024, 0.0000024% / second, 94.61% per year if the pool is 100% utilized
...
const syntheticMarketConfig_IncreasedCapacity: Partial<BaseMarketConfig> = {
...
const baseMarketConfigSonic_A: Partial<BaseMarketConfig> = {
  ...syntheticMarketConfig,

  reserveFactorLongs: percentageToFloat("90%"),
  reserveFactorShorts: percentageToFloat("90%"),

  openInterestReserveFactorLongs: percentageToFloat("85%"),
  openInterestReserveFactorShorts: percentageToFloat("85%"),

  maxLongTokenPoolAmount: expandDecimals(1, 6),
  maxShortTokenPoolAmount: expandDecimals(1, 6),

  maxLongTokenPoolUsdForDeposit: decimalToFloat(900_000, 0),
  maxShortTokenPoolUsdForDeposit: decimalToFloat(900_000, 0),

  negativePositionImpactFactor: percentageToFloat("0.000000005%"),
  positivePositionImpactFactor: percentageToFloat("0.0000000025%"),

  positionImpactPoolDistributionRate: expandDecimals(7, 43),
  minPositionImpactPoolAmount: expandDecimals(3, 19),

  negativeSwapImpactFactor: decimalToFloat(6, 10),
  positiveSwapImpactFactor: decimalToFloat(3, 10),

  minCollateralFactor: decimalToFloat(1, 2),
  ...
  maxOpenInterestForLongs: decimalToFloat(900_000, 0),
  maxOpenInterestForShorts: decimalToFloat(900_000, 0),

  fundingIncreaseFactorPerSecond: decimalToFloat(16, 13),
  fundingDecreaseFactorPerSecond: decimalToFloat(0, 0),

  minFundingFactorPerSecond: decimalToFloat(3, 10),
  maxFundingFactorPerSecond: decimalToFloat(2, 8),

  thresholdForStableFunding: decimalToFloat(5, 2),
  thresholdForDecreaseFunding: decimalToFloat(0, 0),

  borrowingFactorForLongs: decimalToFloat(3, 8),
  borrowingFactorForShorts: decimalToFloat(3, 8),

  borrowingExponentFactorForLongs: decimalToFloat(1, 0),
  borrowingExponentFactorForShorts: decimalToFloat(1, 0),
  ...
  positionFeeFactorForPositiveImpact: percentageToFloat("0.036%"),
  positionFeeFactorForNegativeImpact: percentageToFloat("0.05%"),

  positionImpactExponentFactor: decimalToFloat(22, 1),

  positiveMaxPositionImpactFactor: percentageToFloat("1%"),
  negativeMaxPositionImpactFactor: percentageToFloat("1%"),

  maxPositionImpactFactorForLiquidations: percentageToFloat("0%"),

  swapFeeFactorForPositiveImpact: percentageToFloat("0.036%"),
  swapFeeFactorForNegativeImpact: percentageToFloat("0.05%"),

  atomicSwapFeeFactor: percentageToFloat("0.05%"),

  swapImpactExponentFactor: decimalToFloat(2, 0),

  minCollateralUsd: expandDecimals(1, 0),

  fundingFactor: decimalToFloat(2, 8),
  fundingExponentFactor: decimalToFloat(1, 0),
};

const baseMarketConfigSonic_B: Partial<BaseMarketConfig> = {
  ...syntheticMarketConfig,
  ...
  negativePositionImpactFactor: percentageToFloat("0.0000004%"),
  positivePositionImpactFactor: percentageToFloat("0.0000002%"),

  positionImpactPoolDistributionRate: expandDecimals(166, 42),
  minPositionImpactPoolAmount: expandDecimals(141, 18),

  negativeSwapImpactFactor: decimalToFloat(8, 10),
  positiveSwapImpactFactor: decimalToFloat(4, 10),
  ...
  fundingIncreaseFactorPerSecond: decimalToFloat(174, 14),
  fundingDecreaseFactorPerSecond: decimalToFloat(0, 0),

  minFundingFactorPerSecond: decimalToFloat(3, 10),
  maxFundingFactorPerSecond: decimalToFloat(235, 10),
  ...
  positionImpactExponentFactor: decimalToFloat(2, 0),
...
const baseMarketConfigSonic_C: Partial<BaseMarketConfig> = {
  ...syntheticMarketConfig,
  ...
  maxLongTokenPoolAmount: expandDecimals(5, 5),
  maxShortTokenPoolAmount: expandDecimals(5, 5),

  maxLongTokenPoolUsdForDeposit: decimalToFloat(450_000, 0),
  maxShortTokenPoolUsdForDeposit: decimalToFloat(450_000, 0),

  negativePositionImpactFactor: percentageToFloat("0.0000006%"),
  positivePositionImpactFactor: percentageToFloat("0.0000003%"),

  positionImpactPoolDistributionRate: expandDecimals(166, 43),
  minPositionImpactPoolAmount: expandDecimals(141, 18),

  negativeSwapImpactFactor: decimalToFloat(2, 9),
  positiveSwapImpactFactor: decimalToFloat(1, 9),
  ...
  maxOpenInterestForLongs: decimalToFloat(450_000, 0),
  maxOpenInterestForShorts: decimalToFloat(450_000, 0),

  fundingIncreaseFactorPerSecond: decimalToFloat(181, 14),
  fundingDecreaseFactorPerSecond: decimalToFloat(0, 0),
...
const baseMarketConfigSonic_D: Partial<BaseMarketConfig> = {
  ...syntheticMarketConfig,

  reserveFactorLongs: percentageToFloat("80%"),
  reserveFactorShorts: percentageToFloat("80%"),

  openInterestReserveFactorLongs: percentageToFloat("70%"),
  openInterestReserveFactorShorts: percentageToFloat("70%"),

  maxLongTokenPoolAmount: expandDecimals(3, 5),
  maxShortTokenPoolAmount: expandDecimals(3, 5),

  maxLongTokenPoolUsdForDeposit: decimalToFloat(270_000, 0),
  maxShortTokenPoolUsdForDeposit: decimalToFloat(270_000, 0),

  negativePositionImpactFactor: percentageToFloat("0.000001%"),
  positivePositionImpactFactor: percentageToFloat("0.0000005%"),

  positionImpactPoolDistributionRate: expandDecimals(12, 35),
  minPositionImpactPoolAmount: expandDecimals(15, 11),
  ...
  minCollateralFactorForOpenInterestMultiplierLong: decimalToFloat(7, 9),
  minCollateralFactorForOpenInterestMultiplierShort: decimalToFloat(7, 9),

  maxOpenInterestForLongs: decimalToFloat(270_000, 0),
  maxOpenInterestForShorts: decimalToFloat(270_000, 0),
...
const baseMarketConfigSonic_E: Partial<BaseMarketConfig> = {
  ...syntheticMarketConfig,
  ...
  maxLongTokenPoolAmount: expandDecimals(2, 5),
  maxShortTokenPoolAmount: expandDecimals(2, 5),

  maxLongTokenPoolUsdForDeposit: decimalToFloat(180_000, 0),
  maxShortTokenPoolUsdForDeposit: decimalToFloat(180_000, 0),

  negativePositionImpactFactor: percentageToFloat("0.0000016%"),
  positivePositionImpactFactor: percentageToFloat("0.0000008%"),

  positionImpactPoolDistributionRate: expandDecimals(2, 36),
  minPositionImpactPoolAmount: expandDecimals(1, 12),
  ...
  maxOpenInterestForLongs: decimalToFloat(180_000, 0),
  maxOpenInterestForShorts: decimalToFloat(180_000, 0),
...
const baseMarketConfigSonic_F: Partial<BaseMarketConfig> = {
  ...syntheticMarketConfig,

  reserveFactorLongs: percentageToFloat("0%"), // MISSING in input
  reserveFactorShorts: percentageToFloat("0%"), // MISSING in input

  openInterestReserveFactorLongs: percentageToFloat("0%"), // MISSING in input
  openInterestReserveFactorShorts: percentageToFloat("0%"), // MISSING in input

  maxLongTokenPoolAmount: expandDecimals(0, 0), // MISSING in input
  maxShortTokenPoolAmount: expandDecimals(0, 0), // MISSING in input

  maxLongTokenPoolUsdForDeposit: decimalToFloat(0, 0), // MISSING in input
  maxShortTokenPoolUsdForDeposit: decimalToFloat(0, 0), // MISSING in input

  negativePositionImpactFactor: percentageToFloat("0%"), // MISSING in input
  positivePositionImpactFactor: percentageToFloat("0%"), // MISSING in input

  positionImpactPoolDistributionRate: expandDecimals(0, 0), // MISSING in input
  minPositionImpactPoolAmount: expandDecimals(0, 0), // MISSING in input

  negativeSwapImpactFactor: decimalToFloat(0, 0), // MISSING in input
  positiveSwapImpactFactor: decimalToFloat(0, 0), // MISSING in input

  minCollateralFactor: decimalToFloat(0, 0), // MISSING in input

  minCollateralFactorForOpenInterestMultiplierLong: decimalToFloat(0, 0), // MISSING in input
  minCollateralFactorForOpenInterestMultiplierShort: decimalToFloat(0, 0), // MISSING in input

  maxOpenInterestForLongs: decimalToFloat(0, 0), // MISSING in input
  maxOpenInterestForShorts: decimalToFloat(0, 0), // MISSING in input

  fundingIncreaseFactorPerSecond: decimalToFloat(0, 0), // MISSING in input
  fundingDecreaseFactorPerSecond: decimalToFloat(0, 0), // MISSING in input

  minFundingFactorPerSecond: decimalToFloat(0, 0), // MISSING in input
  maxFundingFactorPerSecond: decimalToFloat(0, 0), // MISSING in input

  thresholdForStableFunding: decimalToFloat(0, 0), // MISSING in input
  thresholdForDecreaseFunding: decimalToFloat(0, 0), // MISSING in input

  borrowingFactorForLongs: decimalToFloat(0, 0), // MISSING in input
  borrowingFactorForShorts: decimalToFloat(0, 0), // MISSING in input

  borrowingExponentFactorForLongs: decimalToFloat(0, 0), // MISSING in input
  borrowingExponentFactorForShorts: decimalToFloat(0, 0), // MISSING in input

  maxPnlFactorForTradersLongs: percentageToFloat("0%"), // MISSING in input
  maxPnlFactorForTradersShorts: percentageToFloat("0%"), // MISSING in input

  maxPnlFactorForAdlLongs: percentageToFloat("0%"), // MISSING in input
  maxPnlFactorForAdlShorts: percentageToFloat("0%"), // MISSING in input

  minPnlFactorAfterAdlLongs: percentageToFloat("0%"), // MISSING in input
  minPnlFactorAfterAdlShorts: percentageToFloat("0%"), // MISSING in input

  maxPnlFactorForDepositsLongs: percentageToFloat("0%"), // MISSING in input
  maxPnlFactorForDepositsShorts: percentageToFloat("0%"), // MISSING in input

  maxPnlFactorForWithdrawalsLongs: percentageToFloat("0%"), // MISSING in input
  maxPnlFactorForWithdrawalsShorts: percentageToFloat("0%"), // MISSING in input

  positionFeeFactorForPositiveImpact: percentageToFloat("0%"), // MISSING in input
  positionFeeFactorForNegativeImpact: percentageToFloat("0%"), // MISSING in input

  positionImpactExponentFactor: decimalToFloat(0, 0), // MISSING in input

  positiveMaxPositionImpactFactor: percentageToFloat("0%"), // MISSING in input
  negativeMaxPositionImpactFactor: percentageToFloat("0%"), // MISSING in input

  maxPositionImpactFactorForLiquidations: percentageToFloat("0%"), // MISSING in input

  swapFeeFactorForPositiveImpact: percentageToFloat("0%"), // MISSING in input
  swapFeeFactorForNegativeImpact: percentageToFloat("0%"), // MISSING in input

  atomicSwapFeeFactor: percentageToFloat("0%"), // MISSING in input

  swapImpactExponentFactor: decimalToFloat(0, 0), // MISSING in input

  minCollateralUsd: expandDecimals(0, 0), // MISSING in input

  fundingFactor: decimalToFloat(0, 0), // MISSING in input
  fundingExponentFactor: decimalToFloat(0, 0), // MISSING in input
};

const baseMarketConfigSonic_Z: Partial<BaseMarketConfig> = {
  ...syntheticMarketConfig,

  reserveFactorLongs: percentageToFloat("75%"),
  reserveFactorShorts: percentageToFloat("75%"),

  openInterestReserveFactorLongs: percentageToFloat("65%"),
  openInterestReserveFactorShorts: percentageToFloat("65%"),

  maxLongTokenPoolAmount: expandDecimals(1, 5),
  maxShortTokenPoolAmount: expandDecimals(1, 5),

  maxLongTokenPoolUsdForDeposit: decimalToFloat(90_000, 0),
  maxShortTokenPoolUsdForDeposit: decimalToFloat(90_000, 0),

  negativePositionImpactFactor: percentageToFloat("0.000002%"),
  positivePositionImpactFactor: percentageToFloat("0.000001%"),
  ...
  maxOpenInterestForLongs: decimalToFloat(90_000, 0),
  maxOpenInterestForShorts: decimalToFloat(90_000, 0),
  ...
  maxPnlFactorForTradersLongs: percentageToFloat("55%"),
  maxPnlFactorForTradersShorts: percentageToFloat("55%"),
  ...
  maxPnlFactorForDepositsLongs: percentageToFloat("55%"),
  maxPnlFactorForDepositsShorts: percentageToFloat("55%"),
...
const syntheticMarketConfigSonic_A: Partial<BaseMarketConfig> = {
  ...baseMarketConfigSonic_A,
...
const syntheticMarketConfigSonic_B: Partial<BaseMarketConfig> = {
  ...baseMarketConfigSonic_B,
...
const syntheticMarketConfigSonic_C: Partial<BaseMarketConfig> = {
  ...baseMarketConfigSonic_C,
...
const syntheticMarketConfigSonic_D: Partial<BaseMarketConfig> = {
  ...baseMarketConfigSonic_D,
...
const syntheticMarketConfigSonic_E: Partial<BaseMarketConfig> = {
  ...baseMarketConfigSonic_E,
...
const syntheticMarketConfigSonic_F: Partial<BaseMarketConfig> = {
  ...baseMarketConfigSonic_F,

  reserveFactorLongs: percentageToFloat("0%"), // MISSING in input, defaulted to 0
  reserveFactorShorts: percentageToFloat("0%"), // MISSING in input, defaulted to 0

  openInterestReserveFactorLongs: percentageToFloat("0%"), // MISSING in input, defaulted to 0
  openInterestReserveFactorShorts: percentageToFloat("0%"), // MISSING in input, defaulted to 0

  maxPnlFactorForTradersLongs: percentageToFloat("0%"), // MISSING in input, defaulted to 0
  maxPnlFactorForTradersShorts: percentageToFloat("0%"), // MISSING in input, defaulted to 0

  maxPnlFactorForAdlLongs: percentageToFloat("0%"), // MISSING in input, defaulted to 0
  maxPnlFactorForAdlShorts: percentageToFloat("0%"), // MISSING in input, defaulted to 0

  minPnlFactorAfterAdlLongs: percentageToFloat("0%"), // MISSING in input, defaulted to 0
  minPnlFactorAfterAdlShorts: percentageToFloat("0%"), // MISSING in input, defaulted to 0

  maxPnlFactorForDepositsLongs: percentageToFloat("0%"), // MISSING in input, defaulted to 0
  maxPnlFactorForDepositsShorts: percentageToFloat("0%"), // MISSING in input, defaulted to 0

  maxPnlFactorForWithdrawalsLongs: percentageToFloat("0%"), // MISSING in input, defaulted to 0
  maxPnlFactorForWithdrawalsShorts: percentageToFloat("0%"), // MISSING in input, defaulted to 0
};

const syntheticMarketConfigSonic_Z: Partial<BaseMarketConfig> = {
  ...baseMarketConfigSonic_Z,
...
const sonicMarketConfigs: MarketConfig[] = [
  // Permissionless Markets
  {
    tokens: { indexToken: "AAVE", longToken: "scUSD", shortToken: "scUSD" },
    virtualTokenIdForIndexToken: hashString("PERP:AAVE/USD"),
    virtualMarketId: hashString("SPOT:AAVE/USD"),
    ...syntheticMarketConfigSonic_E,
  },
  {
    tokens: { indexToken: "ARB", longToken: "scUSD", shortToken: "scUSD" },
    virtualTokenIdForIndexToken: hashString("PERP:ARB/USD"),
    virtualMarketId: hashString("SPOT:ARB/USD"),
    ...syntheticMarketConfigSonic_E,
  },
  {
    tokens: { indexToken: "DOGE", longToken: "scUSD", shortToken: "scUSD" },
    virtualTokenIdForIndexToken: hashString("PERP:DOGE/USD"),
    virtualMarketId: hashString("SPOT:DOGE/USD"),
    ...syntheticMarketConfigSonic_E,
  },
  {
    tokens: { indexToken: "ENA", longToken: "scUSD", shortToken: "scUSD" },
    virtualTokenIdForIndexToken: hashString("PERP:ENA/USD"),
    virtualMarketId: hashString("SPOT:ENA/USD"),
    ...syntheticMarketConfigSonic_E,
  },
  {
    tokens: { indexToken: "ETH/BTC", longToken: "scUSD", shortToken: "scUSD" },
    virtualTokenIdForIndexToken: hashString("PERP:ETH/BTC"),
    virtualMarketId: hashString("SPOT:ETH/BTC"),
    ...syntheticMarketConfigSonic_D,
  },
  {
    tokens: { indexToken: "PEPE", longToken: "scUSD", shortToken: "scUSD" },
    virtualTokenIdForIndexToken: hashString("PERP:PEPE/USD"),
    virtualMarketId: hashString("SPOT:PEPE/USD"),
    ...syntheticMarketConfigSonic_D,
  },
  {
    tokens: { indexToken: "SUI", longToken: "scUSD", shortToken: "scUSD" },
    virtualTokenIdForIndexToken: hashString("PERP:SUI/USD"),
    virtualMarketId: hashString("SPOT:SUI/USD"),
    ...syntheticMarketConfigSonic_A,
  },
  {
    tokens: { indexToken: "WIF", longToken: "scUSD", shortToken: "scUSD" },
    virtualTokenIdForIndexToken: hashString("PERP:WIF/USD"),
    virtualMarketId: hashString("SPOT:WIF/USD"),
    ...syntheticMarketConfigSonic_E,
  },
  {
    tokens: { indexToken: "XRP", longToken: "scUSD", shortToken: "scUSD" },
  ...
  // Manual Markets
  {
    tokens: { indexToken: "WBTC", longToken: "scUSD", shortToken: "scUSD" },
    ...
    maxLongTokenPoolAmount: expandDecimals(1, 7),
    maxShortTokenPoolAmount: expandDecimals(1, 7),

    maxLongTokenPoolUsdForDeposit: decimalToFloat(9_000_000, 0),
    maxShortTokenPoolUsdForDeposit: decimalToFloat(9_000_000, 0),

    negativePositionImpactFactor: percentageToFloat("0%"),
    positivePositionImpactFactor: percentageToFloat("0%"),

    positionImpactPoolDistributionRate: expandDecimals(6, 32),
    minPositionImpactPoolAmount: expandDecimals(2, 8),
    ...
    maxOpenInterestForLongs: decimalToFloat(9_000_000, 0),
    maxOpenInterestForShorts: decimalToFloat(9_000_000, 0),
    ...
    positionImpactExponentFactor: decimalToFloat(1, 0),

    positiveMaxPositionImpactFactor: percentageToFloat("0%"),
    negativeMaxPositionImpactFactor: percentageToFloat("0%"),
  ...
  {
    tokens: { indexToken: "WBTC", longToken: "WS", shortToken: "WS" },
    virtualTokenIdForIndexToken: hashString("PERP:BTC/USD"),
    virtualMarketId: hashString("SPOT:BTC/USD"),
    ...
    maxLongTokenPoolAmount: expandDecimals(2, 7),
    maxShortTokenPoolAmount: expandDecimals(2, 7),

    maxLongTokenPoolUsdForDeposit: decimalToFloat(18_000_000, 0),
    maxShortTokenPoolUsdForDeposit: decimalToFloat(18_000_000, 0),
    ...
    maxOpenInterestForLongs: decimalToFloat(18_000_000, 0),
    maxOpenInterestForShorts: decimalToFloat(18_000_000, 0),
  ...
  {
    tokens: { indexToken: "WETH", longToken: "scUSD", shortToken: "scUSD" },
  ...
  {
    tokens: { indexToken: "WETH", longToken: "WS", shortToken: "WS" },
    virtualTokenIdForIndexToken: hashString("PERP:ETH/USD"),
    virtualMarketId: hashString("SPOT:ETH/USD"),
  ...
  {
    tokens: { indexToken: "WS", longToken: "scUSD", shortToken: "scUSD" },
    virtualTokenIdForIndexToken: hashString("PERP:S/USD"),
    virtualMarketId: hashString("SPOT:S/USD"),
  ...
  {
    tokens: { indexToken: "WS", longToken: "WS", shortToken: "WS" },
    virtualTokenIdForIndexToken: hashString("PERP:S/USD"),
    virtualMarketId: hashString("SPOT:S/USD"),
  ...
  {
    tokens: { indexToken: "SOL", longToken: "scUSD", shortToken: "scUSD" },
  ...
  {
    tokens: { indexToken: "SOL", longToken: "WS", shortToken: "WS" },
    virtualTokenIdForIndexToken: hashString("PERP:SOL/USD"),
    virtualMarketId: hashString("SPOT:SOL/USD"),
  ...
  // Markets not included in Permissionless Markets
  {
    tokens: { indexToken: "HYPE", longToken: "scUSD", shortToken: "scUSD" },
    virtualTokenIdForIndexToken: hashString("PERP:HYPE/USD"),
    virtualMarketId: hashString("SPOT:HYPE/USD"),
    ...syntheticMarketConfigSonic_C,
  },
  {
    tokens: { indexToken: "TRUMP", longToken: "scUSD", shortToken: "scUSD" },
    virtualTokenIdForIndexToken: hashString("PERP:TRUMP/USD"),
    virtualMarketId: hashString("SPOT:TRUMP/USD"),
    ...syntheticMarketConfigSonic_D,
  },
  {
    tokens: { indexToken: "FARTCOIN", longToken: "scUSD", shortToken: "scUSD" },
    virtualTokenIdForIndexToken: hashString("PERP:FARTCOIN/USD"),
    virtualMarketId: hashString("SPOT:FARTCOIN/USD"),
    ...syntheticMarketConfigSonic_D,
  },
];

const arbitrumSepoliaMarketConfigs: MarketConfig[] = [
  {
    tokens: { indexToken: "BTC", longToken: "USDC", shortToken: "USDC" },
    ...baseMarketConfig,
  },
];
...
const config: {
  ...
  arbitrum: [
    ...
    },
    {
      ...
      ...syntheticMarketConfig_IncreasedCapacity,
    ...
    {
      tokens: { indexTokewn: "AAVE", longToken: "AAVE", shortToken: "USDC" },
      virtualTokenIdForIndexToken: hashString("PERP:AAVE/USD"),
      virtualMarketId: hashString("SPOT:AAVE/USD"),
  ...
  arbitrumSepolia: arbitrumSepoliaMarketConfigs,
  arbitrumGoerli: [
    {
      tokens: { indexToken: "WETH", longToken: "WETH", shortToken: "USDC" },
  ...
  sonic: sonicMarketConfigs,
  plasma: [
    {
      tokens: { indexToken: "WXPL", longToken: "WXPL", shortToken: "WXPL" },
    },
  ],
  hardhat: [
    {
...
export default async function (hre: HardhatRuntimeEnvironment) {
  ...
  const tokens = await hre.plasmic.getTokens();
