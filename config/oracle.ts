...
export type OracleProvider = "gmOracle" | "pythDataStream" | "storkOracle" | "chainlinkOracle";
...
export type OracleConfig = {
  ...
  pythFeedSpreadReductionBps?: {
    [feedId: string]: BigNumberish;
  };
};
...
export default async function (hre: HardhatRuntimeEnvironment): Promise<OracleConfig> {
  ...
  const config: { [network: string]: OracleConfig } = {
    ...
    arbitrumSepolia: {
      ...
      storkPriceFeedVerifier: "0x7Bb9740FdcbD91866CaFEd099C36445Ea8140627",
    ...
    sonic: {
      signers: ["0xEd391C02480498543235157164107a70327484Bf"],
      maxOraclePriceAge: 5 * 60, // TODO: check if being used
      maxOracleTimestampRange: 3 * 60, // TODO: check if being used
      maxRefPriceDeviationFactor: decimalToFloat(5, 1), // 50%, TODO: check if being used
      minOracleBlockConfirmations: 255, // TODO: check if being used
      minOracleSigners: 1,
      dataStreamFeedVerifier: hre.ethers.constants.AddressZero,
      storkPriceFeedVerifier: "0xacC0a0cF13571d30B4b8637996F5D6D774d4fd62",
    },

    plasma: {
      signers: ["0x5DD5FEc335C700390AC6EB331DE8097C59346858"],
      maxOraclePriceAge: 5 * 60,
      maxOracleTimestampRange: 3 * 60,
      maxRefPriceDeviationFactor: decimalToFloat(5, 1), // 50%
      minOracleBlockConfirmations: 255,
      minOracleSigners: 1,
      dataStreamFeedVerifier: "0xB4626C56c8d66b09adC57e38a5A15CcCd51BE082",
      storkPriceFeedVerifier: "0xacC0a0cF13571d30B4b8637996F5D6D774d4fd62",
      chainlinkPaymentToken: "0x76a443768A5e3B8d1AED0105FC250877841Deb40",
    },
  };
