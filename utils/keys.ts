...
export const INSURANCE_FUND = hashString("INSURANCE_FUND");
...
export const CLAIMABLE_INSURANCE_FEE_AMOUNT = hashString("CLAIMABLE_INSURANCE_FEE_AMOUNT");
...
export const DATA_STREAM_BASE_ID = hashString("DATA_STREAM_BASE_ID");
export const DATA_STREAM_MULTIPLIER = hashString("DATA_STREAM_MULTIPLIER");
export const DATA_STREAM_SPREAD_REDUCTION = hashString("DATA_STREAM_SPREAD_REDUCTION_FACTOR");
...
export const POSITION_INSURANCE_FUND_FACTOR = hashString("POSITION_INSURANCE_FUND_FACTOR");
...
export function claimableInsuranceFeeAmountKey(market: string, token: string) {
  return hashData(["bytes32", "address", "address"], [CLAIMABLE_INSURANCE_FEE_AMOUNT, market, token]);
}
...
export function dataStreamBaseIdKey(token: string) {
  return hashData(["bytes32", "address"], [DATA_STREAM_BASE_ID, token]);
}
...
export function dataStreamSpreadReductionKey(token: string) {
  return hashData(["bytes32", "address"], [DATA_STREAM_SPREAD_REDUCTION, token]);
}
...
export function withdrawalFeeFactorKey(market: string) {
  return hashData(["bytes32", "address"], [WITHDRAWAL_FEE_FACTOR, market]);
}
