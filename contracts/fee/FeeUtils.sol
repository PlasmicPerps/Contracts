...
library FeeUtils {
    ...
    function incrementClaimableFeeAmount(
     ...
     function incrementClaimableInsuranceFeeAmount(
        DataStore dataStore,
        EventEmitter eventEmitter,
        address market,
        address token,
        ...
        bytes32 key = Keys.claimableInsuranceFeeAmountKey(market, token);
        ...
        emitClaimableInsuranceFeeAmountUpdated(
            eventEmitter,
            market,
            token,
            delta,
    ...
    function incrementClaimableUiFeeAmount(
        ...
        uint256 nextPoolValue = dataStore.applyDeltaToUint(
    ...
    function emitClaimableFeeAmountUpdated(
     ...
     function emitClaimableInsuranceFeeAmountUpdated(
        EventEmitter eventEmitter,
        address market,
        address token,
        uint256 delta,
        ...
        eventEmitter.emitEventLog2(
            "ClaimableInsuranceFeeAmountUpdated",
            Cast.toBytes32(market),
            feeType,
            eventData
        );
    ...
    function emitInsuranceFeesClaimed(
        EventEmitter eventEmitter,
        address market,
        address receiver,
        uint256 feeAmount
