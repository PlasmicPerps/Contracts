...
library PositionPricingUtils {
    ...
    struct PositionBorrowingFees {
        ...
        uint256 borrowingFeeAmountForInsurance;
    }
    ...
    function getPositionFees(
        ...
        fees.feeAmountForPool = fees.positionFeeAmountForPool + fees.borrowing.borrowingFeeAmount 
            - (fees.borrowing.borrowingFeeAmountForFeeReceiver + fees.borrowing.borrowingFeeAmountForInsurance);
        fees.feeReceiverAmount += fees.borrowing.borrowingFeeAmountForFeeReceiver;
        fees.insuranceFeeAmount += fees.borrowing.borrowingFeeAmountForInsurance;
    ...
    function getBorrowingFees(
        ...
        uint256 insuranceFeeFactor = dataStore.getUint(Keys.POSITION_INSURANCE_FUND_FACTOR);
        borrowingFees.borrowingFeeAmountForInsurance = Precision.applyFactor(borrowingFees.borrowingFeeAmount, insuranceFeeFactor);
