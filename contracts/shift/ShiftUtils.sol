...
library ShiftUtils {
    ...
    function executeShift(
        ...
        WithdrawalEventUtils.emitWithdrawalCreated(
            ...
            cache.withdrawalKey,
            cache.withdrawal,
            WithdrawalEventUtils.WithdrawalType.Shift
        );
        ...
        DepositEventUtils.emitDepositCreated(params.eventEmitter, cache.depositKey, cache.deposit, DepositEventUtils.DepositType.Shift);
