...
library ReferralUtils {
    ...
    function incrementAffiliateReward(
        ...
        uint256 nextValue = dataStore.applyDeltaToUint(Keys.affiliateRewardKey(market, token, affiliate), delta);
        uint256 nextPoolValue = dataStore.applyDeltaToUint(Keys.affiliateRewardKey(market, token), delta);
